...
protected:
	...
	void HanderUserQiangDiZhuOfJiaofen(User* pUser,LMsgC2SQiangDiZhu* msg);	//叫分
...
//	Lint            m_nMaxFanshu;      //游戏最大翻倍数;
	...
	CardVec         m_handCard[USER_COUNT_CLASSICAL];//手上的牌 ;
...
//	Lint			m_deskState;//桌子状态;
	...
	ClassicalSubType m_subType;		//0, 经典(叫）， 1：叫分 2：抢地主
};
