...
//OK;
bool CardStyle_SiChuanPiZi::IsRocket(CardVec const& vec,CardVec const& laizi, BYTE& cardNumber)	//是否是火箭;
{
...
//OK;
bool CardStyle_SiChuanPiZi::IsSuperRocket(CardVec const& vec, CardVec const& laizi, BYTE& cardNumber)	//是否是火箭;
{
#if USEASSERT
	assert(vec.size() >= 2);
#endif
...
//OK;
bool CardStyle_SiChuanPiZi::IsDouble(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)	//是否是对子;
{
	if(laizi.size() == 0)
	{
...
//OK
bool CardStyle_SiChuanPiZi::IsBomb1(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)	//纯软炸弹;
{
	if(laizi.size() == 4)
	{
		cardNumber = laizi[0]->GetNumberType();
...
//OK
bool CardStyle_SiChuanPiZi::IsBomb2(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)	//纯硬炸弹;
{
...
//OK
bool CardStyle_SiChuanPiZi::IsBomb3(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)	//软炸弹;
{
	if(laizi.size() == 1)
	{
...
bool CardStyle_SiChuanPiZi::IsSuperBomb(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)	//软炸弹;
{
	if(laizi.size() == 1)
	{
		if(vec.size() == 4 && vec[0]->GetNumberType() == vec[3]->GetNumberType())
...
//OK
bool CardStyle_SiChuanPiZi::IsBombToSingle(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)//四带2单
{
...
//OK
bool CardStyle_SiChuanPiZi::IsBombToDouble(CardVec const& vec,CardVec const& laizi,BYTE& cardType)	//四带2对
{
	std::size_t sLaizi = laizi.size();
...
//OK
bool CardStyle_SiChuanPiZi::IsThree(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)	//是否是三张;
{
...
bool CardStyle_SiChuanPiZi::IsThreeList(CardVec const& vec,CardVec const& laizi,BYTE& cardType)	//飞机;
{
...
//这个函数写的太长了，得想办法优化;
bool CardStyle_SiChuanPiZi::IsThreeListToSingle(CardVec const& vec,CardVec const& laizi,BYTE& cardType)//飞机带单
{
...
//这个函数最麻烦;
bool CardStyle_SiChuanPiZi::IsThreeListToDouble(CardVec const& vec,CardVec const& laizi,BYTE& cardType)//飞机带对;
{
	bool ret = false;
...
//OK
bool CardStyle_SiChuanPiZi::IsThreeToSingle(CardVec const& vec,CardVec const& laizi,BYTE& cardType)//三带1
{
	std::size_t sLaizi = laizi.size();
...
//OK;
bool CardStyle_SiChuanPiZi::IsThreeToDouble(CardVec const& vec,CardVec const& laizi,BYTE& cardType)//三带对;
{
	std::size_t sLaizi = laizi.size();
	CardVec single,duizi,three,four;
	GetSingleDoubleThreeFour(vec,single,duizi,three,four);
...
//OK
bool CardStyle_SiChuanPiZi::IsSingleList(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)//是否是单顺
{
	BYTE type = vec[0]->GetNumberType();
	if(type > card_number_type_A)
	{
...
//OK
bool CardStyle_SiChuanPiZi::IsDoubleList(CardVec const& vec,CardVec const& laizi,BYTE& cardNumber)//是否是双顺;
{
	BYTE type = vec[0]->GetNumberType();
	if(type > card_number_type_A )
	{
