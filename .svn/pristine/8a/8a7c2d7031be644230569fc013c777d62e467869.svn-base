#ifndef _CARD_MANAGER_ARENAPVE_H_
#define _CARD_MANAGER_ARENAPVE_H_

#include "gr_card.h"
#include "LVideo.h"

//////////////////////////////////////////////////////////////////////////
class CardStyle_ArenaPVE
{
public:
	CardStyle_ArenaPVE();
	~CardStyle_ArenaPVE();
	...
	void		CheckCardStyle(CardVec const& src,CardStyleNumberVec& style,bool last, Lint nObjCardStyle = card_style_error);//检查所有符合牌型;
	...
	bool        CheckHasBomb_laizi(CardVec const& Src,CardVec const& laizi, Lint* nBombCard);//查看手牌中是否有炸弹;
...
public:
	static CardStyle_ArenaPVE* Instance();
};

///////////////////////////////////////////////////////////////////////////
//发牌的类;
class CardDeal_ArenaPVE
{
public:
	CardDeal_ArenaPVE();
	~CardDeal_ArenaPVE();
