#ifndef _CARD_MANAGER_PIZI_H_
#define _CARD_MANAGER_PIZI_H_

#include "gr_card.h"
#include "LVideo.h"

//////////////////////////////////////////////////////////////////////////
class CardStyle_SiChuanPiZi
{
public:
	CardStyle_SiChuanPiZi();
	~CardStyle_SiChuanPiZi();
...
public:
	static CardStyle_SiChuanPiZi* Instance();
};

///////////////////////////////////////////////////////////////////////////
//发牌的类;
class CardDeal_SiChuanPiZi
{
public:
	CardDeal_SiChuanPiZi();
	~CardDeal_SiChuanPiZi();
...
////////////////////////////////////////////////////////////////////////////////////////////
class CardHelp_SiChuanPiZi
{
public:
	CardHelp_SiChuanPiZi();
	~CardHelp_SiChuanPiZi();
